<x-admin.wrapper>
    ...
    <div>
        <x-admin.breadcrumb href="{{ route('admin.kasallik.index') }}" title="{{ __('Create Kasallik') }}">
    ...
    <div class="w-full py-2 overflow-hidden">
        <form method="POST" action="{{ route('admin.kasallik.store') }}" enctype="multipart/form-data">
            @csrf
