<x-admin.wrapper>
    ...
    <div>
        <x-admin.breadcrumb href="{{route('admin.user.index')}}" title="{{ __('Yangilash') }}">{{ __('<< Ortga qaytish') }}</x-admin.breadcrumb>
        <x-admin.form.errors />
    </div>
    <div class="w-full py-2 overflow-hidden">
        ...
        @method('PUT')
            ...
            <div class="py-2">
                <x-admin.form.label for="name" class="{{$errors->has('name') ? 'text-red-400' : ''}}">{{ __('Nomi') }}</x-admin.form.label>
            ...
            <div class="py-2">
                <x-admin.form.label for="password" class="{{$errors->has('password') ? 'text-red-400' : ''}}">{{ __('Yangi parol') }}</x-admin.form.label>
            ...
            <div class="py-2">
                <x-admin.form.label for="password_confirmation" class="{{$errors->has('password') ? 'text-red-400' : ''}}">{{ __('Parolni takrorlang') }}</x-admin.form.label>
            ...
            <div class="py-2">
                <h3 class="inline-block text-xl sm:text-2xl font-extrabold text-slate-900 tracking-tight py-4 block sm:inline-block flex">Lavozim</h3>
